...
class Posicioness:
    def __init__(self):
        botonviewposiciones=Button(self.Frameposiciones, text="Mostrar Equipos", command=self.ListarEquipos )#crea un boton con texto dentro y se le pasa la funcion boton1
        botonviewposiciones.config(bg="#008B8B", fg="#191970", font=("Courier", 12, "italic"))
        botonviewposiciones.grid(row=17, column=7,pady=4,sticky="nes")
    ...
    def TablaPosiciones(self):
        ...
        self.Frameposiciones.grid(row=2, column=5, sticky='e')
